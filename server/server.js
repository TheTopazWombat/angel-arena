...
app.post('/api/cards/new', cardCtrl.insertNewCard);

//TOURNAMENT ENDPOINTS
app.get('/api/tournaments/:id', tourneyCtrl.getTournament);
app.post('/api/tournaments/new', tourneyCtrl.createNewTournament);
app.post('/api/tournaments/:id/swiss', tourneyCtrl.createNewSwissRound);
app.put('/api/tournaments/:id/swiss/standings/:matchId', tourneyCtrl.updateTournamentStandings);
...
//     console.log('card position test', obj.position);
//     db.insert_new_card([obj.code, obj.cost, obj.deck_limit, obj.faction_code, obj.side_code, obj.flavor, obj.img_src, obj.keywords, obj.text, obj.type_code, obj.uniqueness, obj.cycle, (obj.minimum_deck_size || null), (obj.faction_cost || obj.influence_limit)], (err, res) => {
//         if (err) console.log(err);
//         else console.log("Successfully added card");
//     });
// };

// insertCardToDb(cards[0]);
...
// console.log('eyyyyy', cards[0].keywords);
